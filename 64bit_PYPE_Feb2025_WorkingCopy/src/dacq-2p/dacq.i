...
**
** Jul 31, 2006 Anitha
**   Added dacq_str_word; this converts a decimal to binary and 
**   sets the appropriate bits
**
** Mar 18, 2008 Anitha
**   Added dacq_open_eyefile (and dacq_close_eyefile) to save eye data 
**   files from the Task files. But its not working yet. See dacq.c
**
** Nov 28 2008 Anitha
**   Added dacq_beep and dacq_beep_on to provide secondary reinforcement
**   independent of juice. The second bit on Port B is now configured for 
...
extern void dacq_str_word(int val);
...
//extern void dacq_open_eyefile(char *name);
//extern void dacq_close_eyefile();
...
extern void dacq_juice(int on, int dobeep, int dojuice);
extern int dacq_juice_drip(int ms, int dobeep, int dojuice);
