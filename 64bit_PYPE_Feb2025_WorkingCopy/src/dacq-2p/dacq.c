...
**
** Tue Aug 1 - 2006 Anitha
**   added dacq_str_word(int val) to write strobed words to plexon
**
**Tue Mar 18, 2008 Anitha
**   Added dacq_open_eyefile (and dacq_close_eyefile) to facilitate
**   saving eye data files in EDF format from Task files in python.
**   But was unclear how to compile it by linking eyelink libraries with SWIG
**   So, its not functional now.
**
** Nov 28 2008 Anitha
**   Added parameters to just provide juice, beep or both
**   The second bit on Port B is now configured for
**   secondary reinforcement
**
** Nov 14 2024 Chenghang
** Some functions are cleaned. For easier compiling and user-reading. 
** They are marked by 11/14. 
*/
...
#include "psems.h"
#include "dacq.h"
#include <core_expt.h> // edited in May 2019, Taekjun
	       ...
	       char *dacq_server, char *arg1, char *arg2)
{
  ...
  if (boot) {
    ...
    dacq_data->openiris_terminate = 0;
...
/// This is the new dacq_str_word to set dacq out lines;
/// Use this in combo with dacq_dig_out to send strobed words
/// Anitha Jul 30 2006
