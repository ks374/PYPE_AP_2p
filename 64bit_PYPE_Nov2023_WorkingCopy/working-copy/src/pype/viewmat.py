...
- Sat Jul 27 23:21:18 2002 mazer
 ...
 - from numpy/Demo/NumTut/view.py
...
def _preprocess(image, xxx_todo_changeme2):
    (scalex,scaley) = xxx_todo_changeme2
...
class PILImage(tkinter.Label):
    def __init__(self, master, data, xxx_todo_changeme):
...
class PPMImage(tkinter.Label):
    def __init__(self, master, ppm, xxx_todo_changeme1):
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        view(z)
        try:
            phase = eval(input("phase (return to quit) = "))
        except:
            break
else:
	try:
